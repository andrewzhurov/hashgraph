...
* TODO dense table rows on multiple events inspection
* TODO pretty table highlight on peek/inspected
* TODO maybe show stake as member's shirt
* TODO ready viz by 3rd February, deploy and get feedback
...
** TODO sync with scroll
** TODO playback one event
** TODO rewind back on scroll up
** TODO freeze to not rewind on scroll
* TODO starting position to issue one event
* TODO pretty design
** TODO perhaps intro section
** TODO layout
** TODO background
* TODO buffer more events ahead-of-time on idle, so it's snappier to viz them
* TODO test on Firefox
* TODO test on Safari
* TODO test on mobile
* TODO test on high res
* TODO fix received events popping
* TODO perhaps untie transitions from rendered events
...
** TODO votes
* TODO cleanup html
* TODO received events may have the same x y, not desired
...
It is 300-600 TIMES faster when storing args by hash in js-obj compared to transient hsah-map. WOW.
** TODO switch mem to js-obj by args hash
