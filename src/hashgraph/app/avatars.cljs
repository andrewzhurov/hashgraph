...
(defn group [color background-color]
  [:svg.avatar.avatar--group
   {:fill        "#000000",
    ;; :xml-space   "preserve",
    ...
    :id          "Layer_1",
    :version     "1.1",
    :viewBox     "-46.14 -46.14 553.65 553.65"}
   [:g
        ...
        [:g
         ...
         [:g
          [:path.outline
           {:fill color,
            :d
            "M164.094,213.389c2.426,3.457,4.937,6.698,7.532,9.742l-7.897,3.756 c-26.286,12.506-48.525,32.075-64.328,56.59c-12.853,19.944-20.909,42.427-23.71,65.865 c-28.562-7.785-54.38-22.22-75.691-41.546v-0.103c0-49.705,29.087-92.609,71.157-112.638 c15.813,15.775,34.323,24.272,53.527,24.272c12.581,0,24.871-3.644,36.291-10.595 C161.977,210.307,163.026,211.862,164.094,213.389z"}]
          [:path
           {:fill "#FCD09F" #_ "#EFC59C",
            :d
            "M138.539,137.707c0,16.431,4.272,34.511,11.878,51.504c-7.953,5.04-16.637,8.009-25.733,8.009 c-38.089,0-68.965-52.094-68.965-90.193c0-38.089,30.876-68.956,68.965-68.956c21.124,0,40.038,9.499,52.684,24.459 C153.883,79.28,138.539,106.737,138.539,137.707z"}]]]]
       [:g
        [:g
         {:id "XMLID_22_"}
         [:g
          [:path.outline
           {:fill color,
            :d
            "M297.273,213.389c-2.426,3.457-4.937,6.698-7.532,9.742l7.897,3.756 c26.286,12.506,48.525,32.075,64.328,56.59c12.853,19.944,20.909,42.427,23.71,65.865c28.562-7.785,54.38-22.22,75.691-41.546 v-0.103c0-49.705-29.087-92.609-71.157-112.638c-15.813,15.775-34.323,24.272-53.527,24.272 c-12.581,0-24.871-3.644-36.291-10.595C299.39,210.307,298.341,211.862,297.273,213.389z"}]
          [:path
           {:fill "#FCD09F" #_"#EFC59C",
            :d
...
(defn computer [color background-color]
  [:svg.avatar.avatar--computer
   ...
   [:g
    {:id "SVGRepo_iconCarrier"}
    [:circle {:fill background-color, :cx "254", :cy "254", :r "254"}]
    [:path.outline
     {:fill color,
    ...
    [:path.outline
     {:fill "#2B3B4E",
      :d
      "M338.8,431.2H173.2l0,0c0-12,10-22,22-22h121.6C328.8,409.2,338.8,419.2,338.8,431.2L338.8,431.2z"}]
    [:polygon
     {:fill "#324A5E",
    ...
    [:path.outline
     {:fill "#324A5E",
      :d
      "M421.2,369.2H86.8c-9.2,0-16.4-7.2-16.4-16.4V140.4c0-9.2,7.2-16.4,16.4-16.4h334.4 c9.2,0,16.4,7.2,16.4,16.4v212.4C437.6,361.6,430.4,369.2,421.2,369.2z"}]
    [:rect
     {:x      "84.4",
      :y      "137.2",
      :fill color,
